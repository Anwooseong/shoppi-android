...
class HomeBannerAdapter : ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(BannerDiffCallback()) {
    ...
    class HomeBannerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val bannerDetailBrandTextView = view.findViewById<TextView>(R.id.tv_banner_detail_brand_label)
        ...
        fun bind(banner: Banner) {
            ...
            GlideApp.with(itemView).load(banner.productDetail.thumbnailImageUrl)
                .into(bannerDetailThumbnailImageView)
            bannerDetailBrandTextView.text = banner.productDetail.brandName
            ...
            priceFormat(bannerDetailPriceTextView, banner.productDetail.price)
        ...
        private fun calculateDiscountAmount(view: TextView, discountRate: Int, price: Int) {
            ...
            priceFormat(view, discountPrice)
        }

        private fun priceFormat(view: TextView, price: Int) {
